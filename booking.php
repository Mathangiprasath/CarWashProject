                    ...
                    <form method="post" id="myform" action="phpsrc/bookingManagement.php">
                        ...
                        <div class="yysm">
                            ...
                            <p>
                                ...
                                </br>(i) wash outside only 1500,
                                </br>(ii) wash inside and outside 2500,
                                </br>(iii) deluxe wash 3000 (which is inside and outside and the car is very dirty),
                                </br>(iV) basic service starts with 150;
                        ...
                        <div class="ky-style">
                            <div class="teacher5-top">
                                <select class="inputNum form-control" name='serviceOption' id="serviceOption">
                                    <option value='1' selected>wash outside only(1500)</option>
                                    <option value='2'>wash inside and outside(2500)</option>
                                    <option value='3'>deluxe wash(3000) </option>
                                    <option value='3'>basic service(starts from 150) </option>
                                </select>
                            </div>
                        </div>
